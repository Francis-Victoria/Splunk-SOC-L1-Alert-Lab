...
Used to store Windows Event Logs, including Security, System and Application logs.



\### sysmon

Used to store Sysmon endpoint telemetry, including process creation events.
